...
//        but fast and small.
    ...
    val uint64MoshiPack get() = MoshiPack(moshi = Moshi.Builder().build())
            .apply {
                writerOptions.writeAllIntsAs = MsgpackIntByte.UINT_64
            }

    val int64MoshiPack
        get() = MoshiPack(moshi = Moshi.Builder().build())
            .apply {
    ...
    fun fixedUint64WorksWithZero() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(0x00)
    ...
    fun fixedUint64WorksWithMaxLong() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(Long.MAX_VALUE)
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedUint64WorksWithMaxInt() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(Int.MAX_VALUE)
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedUint64WorksWithSingleElementArray() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(byteArrayOf(0x00))
        assertArrayEquals(expected, bytes)
    }
    ...
    fun arrayOfUint64WorksWithFixedSize() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(byteArrayOf(0x01, 0x01))
        assertArrayEquals(expected, bytes)
    }
    ...
    fun mapOfUint64WorksWithFixedSize() {
        ...
        val bytes = uint64MoshiPack.packToByteArray(mapOf(1 to 0x03, 2 to 0x04))
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedInt64WorksWithZero() {
        ...
        val bytes = int64MoshiPack. packToByteArray(0x00)
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedInt64WorksWithMaxLong() {
        ...
        val bytes = int64MoshiPack.packToByteArray(Long.MAX_VALUE)
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedInt64WorksWithMaxInt() {
        ...
        val bytes = int64MoshiPack.packToByteArray(Int.MAX_VALUE)
        assertArrayEquals(expected, bytes)
    }
    ...
    fun fixedInt64WorksWithSingleElementArray() {
        ...
        val bytes = int64MoshiPack.packToByteArray(byteArrayOf(0x00))
        assertArrayEquals(expected, bytes)
    }
}
